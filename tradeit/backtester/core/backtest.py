...
from itertools import product, repeat, compress
from numbers import Number

import pandas as pd
import numpy as np
from typing import Callable, Union, Tuple, Dict, List, Type, Sequence
import os

import multiprocessing as mp

from tradeit.backtester.core._plotting import plot
from tradeit.backtester.core._util import try_, _Data, _Indicator, _data_period
from tradeit.backtester.core.backtesting import _Broker, _OutOfMoneyError, _tqdm
from tradeit.backtester.core.startegy import Strategy

def validate_data(data, cash):
